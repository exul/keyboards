function _case_outer_outline_right_extrude_2_outline_fn(){
    return new CSG.Path2D([[309.1431,49.1588564],[304.7868081,-13.1390187]]).appendArc([300.9444541,-16.479126],{"radius":3.6,"clockwise":true,"large":false}).appendPoint([205.2007145,-9.7840715]).appendPoint([211.4785009,-34.8279001]).appendArc([209.4280582,-39.0020287],{"radius":3.6,"clockwise":true,"large":false}).appendPoint([169.6825816,-56.3701421]).appendArc([165.3661867,-55.2381633],{"radius":3.6,"clockwise":true,"large":false}).appendPoint([145.9217467,-29.4397253]).appendArc([145.1961505,-27.2722836],{"radius":3.6,"clockwise":true,"large":false}).appendPoint([145.1961505,55.9353918]).appendArc([148.7961505,59.5353918],{"radius":3.6,"clockwise":true,"large":false}).appendPoint([199.3461505,59.5353918]).appendPoint([199.3461505,65.5103918]).appendArc([202.9461505,69.1103918],{"radius":3.6,"clockwise":true,"large":false}).appendPoint([261.0107533,69.1103918]).appendArc([264.4921132,66.4269795],{"radius":3.6,"clockwise":true,"large":false}).appendPoint([267.3183826,55.6923165]).appendPoint([305.8029927,53.0012103]).appendArc([309.1431,49.1588563],{"radius":3.6,"clockwise":true,"large":false}).close().innerToCAG()
.extrude({ offset: [0, 0, 2] });
}


function _case_walls_right_extrude_4_5_outline_fn(){
    return new CSG.Path2D([[309.1431,49.1588564],[304.7868081,-13.1390187]]).appendArc([300.9444541,-16.479126],{"radius":3.6,"clockwise":true,"large":false}).appendPoint([205.2007145,-9.7840715]).appendPoint([211.4785009,-34.8279001]).appendArc([209.4280582,-39.0020287],{"radius":3.6,"clockwise":true,"large":false}).appendPoint([169.6825816,-56.3701421]).appendArc([165.3661867,-55.2381633],{"radius":3.6,"clockwise":true,"large":false}).appendPoint([145.9217467,-29.4397253]).appendArc([145.1961505,-27.2722836],{"radius":3.6,"clockwise":true,"large":false}).appendPoint([145.1961505,55.9353918]).appendArc([148.7961505,59.5353918],{"radius":3.6,"clockwise":true,"large":false}).appendPoint([199.3461505,59.5353918]).appendPoint([199.3461505,65.5103918]).appendArc([202.9461505,69.1103918],{"radius":3.6,"clockwise":true,"large":false}).appendPoint([261.0107533,69.1103918]).appendArc([264.4921132,66.4269795],{"radius":3.6,"clockwise":true,"large":false}).appendPoint([267.3183826,55.6923165]).appendPoint([305.8029927,53.0012103]).appendArc([309.1431,49.1588563],{"radius":3.6,"clockwise":true,"large":false}).close().innerToCAG()
.subtract(
    new CSG.Path2D([[308.1455359,49.2286129],[303.7892441,-13.0692622]]).appendArc([301.0142106,-15.4815619],{"radius":2.6,"clockwise":true,"large":false}).appendPoint([203.8956141,-8.690368]).appendPoint([210.508512,-35.0710492]).appendArc([209.0276367,-38.0856976],{"radius":2.6,"clockwise":true,"large":false}).appendPoint([169.2821601,-55.4538111]).appendArc([166.1649213,-54.6364798],{"radius":2.6,"clockwise":true,"large":false}).appendPoint([146.7198499,-28.8372041]).appendArc([146.1961505,-27.2722836],{"radius":2.6,"clockwise":true,"large":false}).appendPoint([146.1961505,55.9353918]).appendArc([148.7961505,58.5353918],{"radius":2.6,"clockwise":true,"large":false}).appendPoint([200.3461505,58.5353918]).appendPoint([200.3461505,65.5103918]).appendArc([202.9461505,68.1103918],{"radius":2.6,"clockwise":true,"large":false}).appendPoint([261.0107533,68.1103918]).appendArc([263.5250688,66.1723718],{"radius":2.6,"clockwise":true,"large":false}).appendPoint([266.5337864,54.7447388]).appendPoint([305.7332362,52.0036463]).appendArc([308.1455359,49.2286128],{"radius":2.6,"clockwise":true,"large":false}).close().innerToCAG()
...
function _case_top_snap_right_extrude_4_outline_fn(){
    return new CSG.Path2D([[307.3474847,49.2844181],[302.9911928,-13.013457]]).appendArc([301.0700158,-14.6835107],{"radius":1.8,"clockwise":true,"large":false}).appendPoint([202.8515337,-7.8154053]).appendPoint([209.7325208,-35.2655684]).appendArc([208.7072995,-37.3526327],{"radius":1.8,"clockwise":true,"large":false}).appendPoint([168.9618229,-54.7207462]).appendArc([166.8036255,-54.1547568],{"radius":1.8,"clockwise":true,"large":false}).appendPoint([147.3587116,-28.3556901]).appendArc([146.9961505,-27.2722836],{"radius":1.8,"clockwise":true,"large":false}).appendPoint([146.9961505,55.9353918]).appendArc([148.7961505,57.7353918],{"radius":1.8,"clockwise":true,"large":false}).appendPoint([201.1461505,57.7353918]).appendPoint([201.1461505,65.5103918]).appendArc([202.9461505,67.3103918],{"radius":1.8,"clockwise":true,"large":false}).appendPoint([261.0107533,67.3103918]).appendArc([262.7514333,65.9686857],{"radius":1.8,"clockwise":true,"large":false}).appendPoint([265.9061094,53.9866768]).appendPoint([305.677431,51.205595]).appendArc([307.3474847,49.284418],{"radius":1.8,"clockwise":true,"large":false}).close().innerToCAG()
.subtract(
    new CSG.Path2D([[306.5494334,49.3402233],[302.1931416,-12.9576518]]).appendArc([301.125821,-13.8854594],{"radius":1,"clockwise":true,"large":false}).appendPoint([201.8074534,-6.9404426]).appendPoint([208.9565297,-35.4600877]).appendArc([208.3869623,-36.6195679],{"radius":1,"clockwise":true,"large":false}).appendPoint([168.6414858,-53.9876813]).appendArc([167.4424872,-53.6732428],{"radius":1,"clockwise":true,"large":false}).appendPoint([147.9977637,-27.8744286]).appendArc([147.7961505,-27.2722836],{"radius":1,"clockwise":true,"large":false}).appendPoint([147.7961505,55.9353918]).appendArc([148.7961505,56.9353918],{"radius":1,"clockwise":true,"large":false}).appendPoint([201.9461505,56.9353918]).appendPoint([201.9461505,65.5103918]).appendArc([202.9461505,66.5103918],{"radius":1,"clockwise":true,"large":false}).appendPoint([261.0107533,66.5103918]).appendArc([261.9777977,65.7649995],{"radius":1,"clockwise":true,"large":false}).appendPoint([265.2784324,53.2286147]).appendPoint([305.6216259,50.4075438]).appendArc([306.5494334,49.3402232],{"radius":1,"clockwise":true,"large":false}).close().innerToCAG()
).extrude({ offset: [0, 0, 4] });
}


function _battery_cutout_right_extrude_1_outline_fn(){
    return new CSG.Path2D([[152.3711505,-25.4396082],[180.3711505,-25.4396082]]).appendArc([182.3711505,-23.4396082],{"radius":2,"clockwise":false,"large":false}).appendPoint([182.3711505,15.5603918]).appendArc([180.3711505,17.5603918],{"radius":2,"clockwise":false,"large":false}).appendPoint([152.3711505,17.5603918]).appendArc([150.3711505,15.5603918],{"radius":2,"clockwise":false,"large":false}).appendPoint([150.3711505,-23.4396082]).appendArc([152.3711505,-25.4396082],{"radius":2,"clockwise":false,"large":false}).close().innerToCAG()
.extrude({ offset: [0, 0, 1] });
}


function _battery_switch_wall_cutout_left_extrude_2_5_outline_fn(){
    return new CSG.Path2D([[140.9461505,21.4603918],[148.9461505,21.4603918]]).appendPoint([148.9461505,30.4603918]).appendPoint([140.9461505,30.4603918]).appendPoint([140.9461505,21.4603918]).close().innerToCAG()
.extrude({ offset: [0, 0, 2.5] });
}


function _mcu_bottom_cutout_right_extrude_1_outline_fn(){
    return new CSG.Path2D([[162.7961505,29.4353918],[182.2961505,29.4353918]]).appendPoint([182.2961505,56.9353918]).appendPoint([162.7961505,56.9353918]).appendPoint([162.7961505,29.4353918]).close().innerToCAG()
.extrude({ offset: [0, 0, 1] });
}


function _usbc_cutout_right_extrude_4_5_outline_fn(){
    return new CSG.Path2D([[168.0461505,49.9353918],[177.0461505,49.9353918]]).appendPoint([177.0461505,59.5353918]).appendPoint([168.0461505,59.5353918]).appendPoint([168.0461505,49.9353918]).close().innerToCAG()
.extrude({ offset: [0, 0, 4.5] });
}
...
.extrude({ offset: [0, 0, 1] });
                ...
                function left_case_top_case_fn() {
                    

                // creating part 0 of case left_case_top
                let left_case_top__part_0 = _case_outer_outline_right_extrude_2_outline_fn();

                // make sure that rotations are relative
                let left_case_top__part_0_bounds = left_case_top__part_0.getBounds();
                let left_case_top__part_0_x = left_case_top__part_0_bounds[0].x + (left_case_top__part_0_bounds[1].x - left_case_top__part_0_bounds[0].x) / 2
                let left_case_top__part_0_y = left_case_top__part_0_bounds[0].y + (left_case_top__part_0_bounds[1].y - left_case_top__part_0_bounds[0].y) / 2
                left_case_top__part_0 = translate([-left_case_top__part_0_x, -left_case_top__part_0_y, 0], left_case_top__part_0);
                left_case_top__part_0 = rotate([0,0,0], left_case_top__part_0);
                left_case_top__part_0 = translate([left_case_top__part_0_x, left_case_top__part_0_y, 0], left_case_top__part_0);

                left_case_top__part_0 = translate([0,0,0], left_case_top__part_0);
                let result = left_case_top__part_0;
                
            

                // creating part 1 of case left_case_top
                let left_case_top__part_1 = _case_walls_right_extrude_4_5_outline_fn();

                // make sure that rotations are relative
                let left_case_top__part_1_bounds = left_case_top__part_1.getBounds();
                let left_case_top__part_1_x = left_case_top__part_1_bounds[0].x + (left_case_top__part_1_bounds[1].x - left_case_top__part_1_bounds[0].x) / 2
                let left_case_top__part_1_y = left_case_top__part_1_bounds[0].y + (left_case_top__part_1_bounds[1].y - left_case_top__part_1_bounds[0].y) / 2
                left_case_top__part_1 = translate([-left_case_top__part_1_x, -left_case_top__part_1_y, 0], left_case_top__part_1);
                left_case_top__part_1 = rotate([0,0,0], left_case_top__part_1);
                left_case_top__part_1 = translate([left_case_top__part_1_x, left_case_top__part_1_y, 0], left_case_top__part_1);

                left_case_top__part_1 = translate([0,0,0], left_case_top__part_1);
                result = result.union(left_case_top__part_1);
                
            

                // creating part 2 of case left_case_top
                let left_case_top__part_2 = _keys_extrude_2_outline_fn();

                // make sure that rotations are relative
                let left_case_top__part_2_bounds = left_case_top__part_2.getBounds();
                let left_case_top__part_2_x = left_case_top__part_2_bounds[0].x + (left_case_top__part_2_bounds[1].x - left_case_top__part_2_bounds[0].x) / 2
                let left_case_top__part_2_y = left_case_top__part_2_bounds[0].y + (left_case_top__part_2_bounds[1].y - left_case_top__part_2_bounds[0].y) / 2
                left_case_top__part_2 = translate([-left_case_top__part_2_x, -left_case_top__part_2_y, 0], left_case_top__part_2);
                left_case_top__part_2 = rotate([0,0,0], left_case_top__part_2);
                left_case_top__part_2 = translate([left_case_top__part_2_x, left_case_top__part_2_y, 0], left_case_top__part_2);

                left_case_top__part_2 = translate([0,0,0], left_case_top__part_2);
                result = result.subtract(left_case_top__part_2);
                
            

                // creating part 3 of case left_case_top
                let left_case_top__part_3 = _case_top_snap_right_extrude_4_outline_fn();

                // make sure that rotations are relative
                let left_case_top__part_3_bounds = left_case_top__part_3.getBounds();
                let left_case_top__part_3_x = left_case_top__part_3_bounds[0].x + (left_case_top__part_3_bounds[1].x - left_case_top__part_3_bounds[0].x) / 2
                let left_case_top__part_3_y = left_case_top__part_3_bounds[0].y + (left_case_top__part_3_bounds[1].y - left_case_top__part_3_bounds[0].y) / 2
                left_case_top__part_3 = translate([-left_case_top__part_3_x, -left_case_top__part_3_y, 0], left_case_top__part_3);
                left_case_top__part_3 = rotate([0,0,0], left_case_top__part_3);
                left_case_top__part_3 = translate([left_case_top__part_3_x, left_case_top__part_3_y, 0], left_case_top__part_3);

                left_case_top__part_3 = translate([0,0,0], left_case_top__part_3);
                result = result.union(left_case_top__part_3);
                
            

                // creating part 4 of case left_case_top
                let left_case_top__part_4 = _battery_cutout_right_extrude_1_outline_fn();

                // make sure that rotations are relative
                let left_case_top__part_4_bounds = left_case_top__part_4.getBounds();
                let left_case_top__part_4_x = left_case_top__part_4_bounds[0].x + (left_case_top__part_4_bounds[1].x - left_case_top__part_4_bounds[0].x) / 2
                let left_case_top__part_4_y = left_case_top__part_4_bounds[0].y + (left_case_top__part_4_bounds[1].y - left_case_top__part_4_bounds[0].y) / 2
                left_case_top__part_4 = translate([-left_case_top__part_4_x, -left_case_top__part_4_y, 0], left_case_top__part_4);
                left_case_top__part_4 = rotate([0,0,0], left_case_top__part_4);
                left_case_top__part_4 = translate([left_case_top__part_4_x, left_case_top__part_4_y, 0], left_case_top__part_4);

                left_case_top__part_4 = translate([0,0,1], left_case_top__part_4);
                result = result.subtract(left_case_top__part_4);
                
            

                // creating part 5 of case left_case_top
                let left_case_top__part_5 = _battery_switch_wall_cutout_left_extrude_2_5_outline_fn();

                // make sure that rotations are relative
                let left_case_top__part_5_bounds = left_case_top__part_5.getBounds();
                let left_case_top__part_5_x = left_case_top__part_5_bounds[0].x + (left_case_top__part_5_bounds[1].x - left_case_top__part_5_bounds[0].x) / 2
                let left_case_top__part_5_y = left_case_top__part_5_bounds[0].y + (left_case_top__part_5_bounds[1].y - left_case_top__part_5_bounds[0].y) / 2
                left_case_top__part_5 = translate([-left_case_top__part_5_x, -left_case_top__part_5_y, 0], left_case_top__part_5);
                left_case_top__part_5 = rotate([0,0,0], left_case_top__part_5);
                left_case_top__part_5 = translate([left_case_top__part_5_x, left_case_top__part_5_y, 0], left_case_top__part_5);

                left_case_top__part_5 = translate([0,0,2], left_case_top__part_5);
                result = result.subtract(left_case_top__part_5);
                
            

                // creating part 6 of case left_case_top
                let left_case_top__part_6 = _mcu_bottom_cutout_right_extrude_1_outline_fn();

                // make sure that rotations are relative
                let left_case_top__part_6_bounds = left_case_top__part_6.getBounds();
                let left_case_top__part_6_x = left_case_top__part_6_bounds[0].x + (left_case_top__part_6_bounds[1].x - left_case_top__part_6_bounds[0].x) / 2
                let left_case_top__part_6_y = left_case_top__part_6_bounds[0].y + (left_case_top__part_6_bounds[1].y - left_case_top__part_6_bounds[0].y) / 2
                left_case_top__part_6 = translate([-left_case_top__part_6_x, -left_case_top__part_6_y, 0], left_case_top__part_6);
                left_case_top__part_6 = rotate([0,0,0], left_case_top__part_6);
                left_case_top__part_6 = translate([left_case_top__part_6_x, left_case_top__part_6_y, 0], left_case_top__part_6);

                left_case_top__part_6 = translate([0,0,1], left_case_top__part_6);
                result = result.subtract(left_case_top__part_6);
                
            

                // creating part 7 of case left_case_top
                let left_case_top__part_7 = _usbc_cutout_right_extrude_4_5_outline_fn();

                // make sure that rotations are relative
                let left_case_top__part_7_bounds = left_case_top__part_7.getBounds();
                let left_case_top__part_7_x = left_case_top__part_7_bounds[0].x + (left_case_top__part_7_bounds[1].x - left_case_top__part_7_bounds[0].x) / 2
                let left_case_top__part_7_y = left_case_top__part_7_bounds[0].y + (left_case_top__part_7_bounds[1].y - left_case_top__part_7_bounds[0].y) / 2
                left_case_top__part_7 = translate([-left_case_top__part_7_x, -left_case_top__part_7_y, 0], left_case_top__part_7);
                left_case_top__part_7 = rotate([0,0,0], left_case_top__part_7);
                left_case_top__part_7 = translate([left_case_top__part_7_x, left_case_top__part_7_y, 0], left_case_top__part_7);

                left_case_top__part_7 = translate([0,0,0], left_case_top__part_7);
                result = result.subtract(left_case_top__part_7);
                
            

                // creating part 8 of case left_case_top
                let left_case_top__part_8 = _jumper_pads_cutout_extrude_1_outline_fn();

                // make sure that rotations are relative
                let left_case_top__part_8_bounds = left_case_top__part_8.getBounds();
                let left_case_top__part_8_x = left_case_top__part_8_bounds[0].x + (left_case_top__part_8_bounds[1].x - left_case_top__part_8_bounds[0].x) / 2
                let left_case_top__part_8_y = left_case_top__part_8_bounds[0].y + (left_case_top__part_8_bounds[1].y - left_case_top__part_8_bounds[0].y) / 2
                left_case_top__part_8 = translate([-left_case_top__part_8_x, -left_case_top__part_8_y, 0], left_case_top__part_8);
                left_case_top__part_8 = rotate([0,0,0], left_case_top__part_8);
                left_case_top__part_8 = translate([left_case_top__part_8_x, left_case_top__part_8_y, 0], left_case_top__part_8);

                left_case_top__part_8 = translate([0,0,1], left_case_top__part_8);
                result = result.subtract(left_case_top__part_8);
